...
const TILE_CLASS =
  "flex h-[120px] w-[200px] shrink-0 cursor-pointer items-center justify-center rounded-sm border border-[#001a48]/35  bg-white p-4 transition duration-200 hover:border-blue-300 hover:shadow-lg"
