          ...
          {displayCities.map((city, index) => {
            ...
            return (
              <button
                ...
                className="group overflow-hidden rounded-lg border border-gray-200 bg-white text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                {/* Image */}
