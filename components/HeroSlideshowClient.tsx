...
export default function HeroSlideshowClient({
  ...
  return (
    <section
      ...
      className="relative bg-[#F7FBFF] w-full min-w-0 overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-[28px]"
    >
      {/* Background Image */}
      {/* <div
        className="
...
>
          ...
          <div className="flex w-full min-w-0 flex-col gap-3 sm:gap-4 lg:w-[68%] lg:gap-5">
            ...
            <div className="relative w-full min-w-0 overflow-hidden rounded-xl shadow-[0_5px_20px_-4px_rgba(0,0,0,0.75)]">
