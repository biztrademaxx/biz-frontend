...
export default function HeroSlideshowSkeleton() {
  return (
    <section
      className="relative bg-[#F8F5EE] w-full min-w-0 overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-[28px]"
      aria-busy="true"
    ...
    >
      <div
        ...
        aria-hidden
      />
      <div className="absolute inset-0 bg-[#E8F4FF]" aria-hidden />
