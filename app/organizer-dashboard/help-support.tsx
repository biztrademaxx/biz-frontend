        ...
        <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 space-y-12">
            ...
            <section className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
                    <HelpCircle className="text-[#5b21b6]" size={28} />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg space-y-6 border border-gray-100">
                <h2 className="text-2xl font-bold flex items-center gap-2">
                    <MessageCircle className="text-[#5b21b6]" size={28} />
                    Contact Support
                </h2>
                <p className="text-gray-700">
                    Welcome to the Organizer Support Center of <span className="font-semibold text-[#5b21b6]">BizTradeFairs.com</span>.
                    We're here to ensure your event management experience is seamless, efficient, and successful.
                </p>

                <div className="space-y-4">
                    <div className="p-4 bg-[#8E54E9]/10 rounded-lg border border-[#ede9fe]">
                        <div className="flex items-start gap-3">
                            <Mail className="text-[#5b21b6] mt-1 flex-shrink-0" size={20} />
                            <div>
                                ...
                                <p className="text-[#5b21b6] font-medium mt-2">organizer-support@biztradefairs.com</p>
                            </div>
                        </div>
                    </div>
            ...
            {/* <section className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="#" className="p-4 border border-gray-200 rounded-lg hover:bg-[#8E54E9]/10 hover:border-[#c4b5fd] transition flex flex-col items-center text-center">
                        <Calendar className="text-[#5b21b6] mb-2" size={32} />
            ...
            {/* <section className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
                    <Send className="text-[#5b21b6]" size={28} />
                    Send Us a Message
                </h2> */}
                {/* <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full border border-gray-300 rounded-md pl-10 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#8E54E9] focus:border-[#8E54E9] transition"
                                    required
                                />
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={5}
                            className="w-full border border-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-[#8E54E9] focus:border-[#8E54E9] transition"
                            required
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="bg-[#4776E6] text-white px-6 py-3 rounded-md hover:bg-[#3556b8] transition flex items-center justify-center gap-2 w-full font-medium"
                    >
                        <Send size={20} />
                        Send Message
                    </button>
