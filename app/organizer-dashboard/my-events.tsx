...
export default function MyEvents({ organizerId }: MyEventsProps) {
    ...
    return (
        <div className="space-y-4 bg-white rounded-xl p-4 sm:p-6">
            ...
            — stacks vertically on mobile instead of squeezing three
            controls into one row; becomes a row again at sm: and up. */}
                        ...
                        {paginatedEvents.map((event: Event) => {
                            ...
                            return (
                                <Card
                                    ...
                                    className="h-full overflow-hidden p-0 bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group"
                                >
                                        ...
                                        <CardContent className="flex-1 p-5 bg-white">
                                            <div className="flex flex-col justify-between h-full">
                                                <div className="space-y-3">
                                                    ...
                                                    {/* Category pills — own flex-wrap row, sitting inline next
                              to each other instead of being forced onto separate
                              full-width lines by the icon rows' space-y-2 above. */}
                        ...
                        <div className="flex items-center justify-center gap-2 pt-2 flex-wrap">
                            ...
                            {getPageNumbers().map((page) => (
                                <Button
                                    key={page}
                                    size="icon"
                                    className={`h-9 w-9 text-sm font-medium ${currentPage === page
