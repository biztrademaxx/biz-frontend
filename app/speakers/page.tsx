...
>
                  {pagedSpeakers.map((speaker) => (
                    <article
                      ...
                      className={`group cursor-pointer overflow-hidden rounded-[22px] border border-[#E4EAF5] bg-white shadow-[0_10px_28px_rgba(16,42,94,0.08)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_16px_40px_rgba(16,42,94,0.12)] flex flex-col ${
                        viewMode === "grid" ? "h-[260px] p-4" : "p-4 sm:flex-row sm:items-start sm:gap-6 sm:h-auto"
                      }`}
                    >
                      {/* ── Top: avatar + name/designation ── */}
                      <div className={`flex items-center gap-3 flex-shrink-0 ${viewMode === "list" ? "sm:w-[220px]" : ""}`}>
                        <Avatar className="h-14 w-14 flex-shrink-0 border border-[#DDE5F3] shadow-[0_4px_12px_rgba(16,42,94,0.08)]">
                          ...
                          />
                          <AvatarFallback className={`${getSpeakerAvatarStyles(speaker)} font-semibold text-sm`}>
                      ...
                      <div className={`flex flex-col gap-1.5 overflow-hidden ${viewMode === "grid" ? "mt-3 flex-1" : "mt-2 sm:mt-0 sm:flex-1"}`}>
                        {speaker.company ? (
                          <div className="flex items-center gap-1.5 text-[0.78rem] text-[#123D86]">
                        ...
                        {speaker.location ? (
                          <div className="flex items-center gap-1.5 text-[0.78rem] text-[#445C8E]">
                      ...
                      <div className={`border-t border-[#E4EAF5] pt-3 ${viewMode === "grid" ? "mt-auto" : "mt-2 sm:mt-auto sm:border-l sm:border-t-0 sm:pl-4 sm:pt-0 sm:w-[160px] sm:flex-shrink-0 sm:self-center"}`}>
                        <div className="grid grid-cols-2 gap-0">
                          <div className="pr-3 text-center">
                            <div className="flex items-center justify-center gap-1 text-[#123D86]">
                              <Mic className="h-3.5 w-3.5" />
                              <span className="text-[1rem] font-semibold">
                                {getSpeakerTotalEvents(speaker)}
                              </span>
                            </div>
                            <p className="mt-0.5 text-[0.7rem] text-[#445C8E]">Total Events</p>
                          </div>

                          <div className="border-l border-[#E4EAF5] pl-3 text-center">
                            <div className="flex items-center justify-center gap-1 text-[#123D86]">
                            ...
                            <p className="mt-0.5 text-[0.7rem] text-[#445C8E]">Upcoming</p>
                          </div>
                        </div>
                      </div>
                    </article>
                  ...
                  <aside className="sticky top-6 h-fit overflow-hidden rounded-[22px] bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.08),transparent_32%),linear-gradient(135deg,#0E2E67_0%,#133E8A_100%)] p-5 text-white shadow-[0_18px_50px_rgba(18,61,134,0.2)]">
      
      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 ">
        <UsersRound className="h-5 w-5" />
      </div>

      <h3 className="mt-4 font-display text-[1.42rem] font-semibold">
        Are you a speaker?
      </h3>

      <p className="mt-2.5 text-[0.88rem] leading-6 text-white/88">
      ...
      <Button
        ...
        className="mt-4 h-[42px] rounded-2xl bg-white px-4 text-sm font-semibold text-[#123D86]"
      >
        Join as a Speaker
